...
(function() {
	...
	mywebsite = (function() {
		...
		mywebsite.prototype.animateHomeimg = function() {
			return jQuery("html").waypoint(function() {
				return new Animo({
					el: jQuery("#home h1.splash-head"),
					duration: 1500,
					delay: 800,
					template: {
						opacity: [0, 1],
	...
	mywebsite.prototype.animateServices = function() {
			return jQuery("#services").waypoint(function() {
				return new Animo({
					el: jQuery("#servicesh2.content-head.is-center, #services h3.content-subhead, #services  p.service-text" ),
					duration: 800,
					delay: 1000,
					template: {
						opacity: [0, 1],
			...
			mywebsite.prototype.animatePrice = function() {
			return jQuery("#price").waypoint(function() {
				return new Animo({
					el: jQuery("#price img.pure-img-responsive.left-block.opacity" ),
					delay: 1900,
					duration: 600,
					template: {
						translateX: [-50, 0, "%"],
					...
					, {
					el: jQuery("#price div.pure-u-1.pure-u-med-1-2.pure-u-lrg-3-5.right-block.opacity"),
					delay: 1900,
					duration: 600,
					template: {
						translateX: [50, 0, "%"],
...
mywebsite.prototype.animateGallery = function() {
			return jQuery("#gallery").waypoint(function() {
				return new Animo({
					el: jQuery("#gallery.left-block.opacity" ),
					delay: 1900,
					duration: 600,
					template: {
						translateX: [-50, 0, "%"],
...
mywebsite.prototype.animateContact = function() {
			return jQuery("#contact").waypoint(function() {
				return new Animo({
					el: jQuery("#contact div.pure-g.left-block.opacity" ),
					delay: 1900,
					duration: 600,
					template: {
						translateX: [-50, 0, "%"],
					...
					, {
					el: jQuery("#contact div.l-box-lrg.pure-u-1.pure-u-med-3-5.right-block.opacity"),
					delay: 1900,
					duration: 600,
					template: {
						translateX: [50, 0, "%"],
